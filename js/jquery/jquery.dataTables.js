...
(/** @lends <global> */function(window, document, undefined) {
	 ...
	 *    } );
		...
		function _fnCreateTr(oSettings, iRow, nTrIn, anTds) {
			...
			if (row.nTr === null) {
				...
				_fnCallbackFire(oSettings, 'aoRowCreatedCallback', null, [nTr,
																		  rowData,
																		  iRow]);
			}
		}
		...
		function _fnLengthChange(settings, val) {
			...
			_fnCallbackFire(settings, null, 'length', [settings,
													   len]);
		}
		...
		function _fnProcessingDisplay(settings, show) {
			...
			_fnCallbackFire(settings, null, 'processing', [settings,
														   show]);
		}
		...
		function _fnSaveState(oSettings) {
			...
			_fnCallbackFire(oSettings, "aoStateSaveParams", 'stateSaveParams', [oSettings,
																				oState]);
		...
		function _fnLoadState(oSettings, oInit) {
			 ...
			 */
			var abStateLoad = _fnCallbackFire(oSettings, 'aoStateLoadParams', 'stateLoadParams', [oSettings,
																								  oData]);
			...
			_fnCallbackFire(oSettings, 'aoStateLoaded', 'stateLoaded', [oSettings,
																		oData]);
		}
		 ...
		 *    } );
			...
			this.each(function() {
				...
				_fnMap(oSettings, oInit, [
					...
					"renderer",
					["iCookieDuration",
					 "iStateDuration"], // backwards compat
					["oSearch",
					 "oPreviousSearch"],
					["aoSearchCols",
					 "aoPreSearchCols"],
	 ...
	 *       }
		...
		var __setColumnVis = function(settings, column, vis) {
			...
			_fnCallbackFire(settings, null, 'column-visibility', [settings,
																  column,
																  vis]);
