		...
		version: "1.0.0", options: {
			...
			a.element.on("click", ".accordion-frame > .heading", function(b) {
				...
				if (!c(this).attr("disabled") && "none" != c(this).data("action")) {
					...
					console.log(this);
					c(e).is(":hidden") ? (c(e).slideDown(), c(this).removeClass("collapsed"), a._trigger("frame", b, {frame: d}), a.options.open(d)) : (c(e).slideUp(), c(this).addClass("collapsed"));
					a.options.action(d)
				}
			});
			this.element.children(".accordion-frame").each(function() {
				var a = c(this).children(".heading"), d = c(this).children(".content");
...
var dateFormat = function() {
	...
	return function(e, f, g) {
		...
		var k = g ? "getUTC" : "get", h = e[k + "Date"](), l = e[k + "Day"](), n = e[k + "Month"](), p = e[k + "FullYear"](), m = e[k + "Hours"](), q = e[k + "Minutes"](), u = e[k + "Seconds"](), k = e[k + "Milliseconds"](), r = g ? 0 : e.getTimezoneOffset(), s = {
			d: h,
			dd: d(h),
			...
			S: ["th",
				"st",
				"nd",
				"rd"][3 < h % 10 ? 0 : (10 != h % 100 - h % 10) * h % 10]
		};
...
(function(c) {
	c.widget("metro.calendar", {
		...
		_create: function() {
			...
			this._distance = parseInt(this.options.date.getUTCFullYear()) -
			4;
		...
		_renderMonth: function() {
			...
			var e = ["31",
					 ...
					 "31",
					 "30",
					 "31"], f = e[b], g = (new Date(a, b, 1)).getUTCDay(), h, k;
			this.element.html("");
		...
		setDate: function(a) {
			...
			a = (new Date(a.getUTCFullYear() +
						  "/" + (a.getUTCMonth() + 1) + "/" + a.getUTCDate())).format("yyyy-mm-dd");
			this._addDate(a);
			this._renderCalendar()
		},
		getDate: function(a) {
		...
		unsetDate: function(a) {
			a = new Date(a);
			a = (new Date(a.getUTCFullYear() + "-" + (a.getUTCMonth() + 1) + "-" + a.getUTCDate())).format("yyyy-mm-dd");
			this._removeDate(a);
			this._renderCalendar()
		},
		_destroy: function() {
...
(function(c) {
	c.widget("metro.carousel", {
		...
		options: {
			...
			effect: "slowdown",
			direction: "left",
			markers: {show: !0, type: "default", position: "left"},
			controls: !0,
			stop: !0,
			width: "100%",
			height: 300
...
(function(c) {
	c.widget("metro.countdown", {
		version: "1.0.0", options: {
			style: {background: "bg-dark", foreground: "fg-white", divider: "fg-dark"}, blink: !0, days: 1, stoptimer: 0, ontick: function(a, b, c, e) {
			}, onstop: function() {
			}
...
(function(c) {
	c.widget("metro.livetile", {
		version: "1.0.0",
		options: {effect: "slideLeft", period: 4E3, duration: 700, easing: "doubleSqrt"},
		_frames: {},
		_currentIndex: 0,
		_interval: 0,
		_outPosition: 0,
...
(function(c) {
	c.widget("metro.progressbar", {
		version: "1.0.1", options: {
			value: 0, color: "bg-cyan", animate: !1, max: 100, onchange: function(a) {
			}
		}, _create: function() {
			...
			if (void 0 != a)a = parseInt(a), a = a > this.max ? this.max : a, a = 0 > a ? 0 : a, this._showBar(a), this.options.value = a; else return parseInt(this.options.value)
		}, color: function(a) {
			this.options.color =
				a;
...
(function(c) {
	c.widget("metro.slider", {
		version: "1.0.2", options: {
			position: 0, accuracy: 0, color: "default", completeColor: "default", markerColor: "default", colors: [], showHint: !1, change: function(a, b) {
			}, changed: function(a, b) {
			}, min: 0, max: 100, animate: !0, _slider: {vertical: !1, offset: 0, length: 0, marker: 0, ppp: 0, start: 0, stop: 0}
		}, _create: function() {
...
(function(c) {
	c.widget("metro.tablecontrol", {
		version: "1.0.0", options: {width: "100%", height: "auto", cls: "table", checkRow: !1, colModel: [], data: []}, _create: function() {
			var a = this.element;
...
(function(c) {
	c.widget("metro.times", {
		version: "1.0.0", options: {
			style: {background: "bg-dark", foreground: "fg-white", divider: "fg-dark"}, blink: !0, alarm: {h: 0, m: 0, s: 0}, ontick: function(a, b, c) {
			}, onalarm: function() {
			}
		}, wrappers: {}, _interval: 0, _create: function() {
			var a = this, b = this.element;
...
(function(c) {
	var a = !1, b = [], d = {
		...
		_notify: null,
		_timer: null,
		options: {icon: "", caption: "", content: "", shadow: !0, width: "auto", height: "auto", style: !1, position: "right", timeout: 3E3},
		init: function(a) {
...
(function(c) {
	c.widget("metro.hint", {
		version: "1.0.0", options: {position: "bottom", background: "#FFFCC0", shadow: !1, border: !1, mode: 1, _hint: void 0}, _create: function() {
			...
			var e = 1 < b.length ? b[0] : !1, f = 1 < b.length ? b[1] : b[0], b = c("<div/>").appendTo("body");
...
(function(c) {
	c.widget("metro.streamer", {
		version: "1.0.0",
		options: {
			scrollBar: !1, meter: {start: 9, stop: 19, interval: 20}, slideToGroup: 1, slideToTime: "10:20", slideSleep: 1E3, slideSpeed: 1E3, onClick: function(a) {
		...
		_create: function() {
			...
			for (p = d.meter.start; p < u; p++)for (m = 0; 60 > m; m += r)q = (10 > p ? "0" + p : p) + ":" + (10 > m ? "0" + m : m), c("<li/>").addClass("js-interval-" + q.replace(":", "-")).html("<em>" + q + "</em>").appendTo(n), s.push(q);
			b.data("intervals", s);
...
(function(c) {
	c.widget("metro.scrollbar", {
		...
		startSize: {width: null, height: null},
		elemPadding: !1,
		bothScroll: !1,
		scrollbar: null,
		contentHeight: 0,
		...
		_clickPos: function(a,
			...
			if ("scrollbar-line-v" == c(a.target).attr("class") || "scrollbar-line-h" == c(a.target).attr("class")) {
				...
				if ("scrollbar-line-v" == c(a.target).attr("class")) {
					...
					e = a.pageX - d.left, f = b.find(".scrollbar-line-h-btn"), this.dragElem = {
...
(function(c) {
	c.widget("metro.stepper", {
		version: "1.0.0", options: {
			steps: 3, start: 1, onStep: function(a, b) {
			}
		}, _create: function() {
			var a = this.element, b = this.options;
