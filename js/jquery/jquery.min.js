...
(function(e, undefined) {
	...
	x.fn = x.prototype = {
		jquery: f, constructor: x, init: function(e, t, n) {
			...
			if (!e)return this;
			if ("string" == typeof e) {
				if (r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null,
																								  e,
																								  null] : T.exec(e), !r || !r[1] && t) {
	...
	t = x(o), function(e, undefined) {
		...
		s = ot.isXML = function(e) {
			...
			filter: {
				TAG: function(e) {
					...
					return 1 === r && 0 === i ? function(e) {
						...
						if (m) {
							if (o) {
								while (g) {
									f = t;
									while (f = f[g])if (a ? f.nodeName.toLowerCase() === y : 1 === f.nodeType)return !1;
							...
							if (d = [s ? m.firstChild : m.lastChild], s && x) {
								...
								while (f = ++h && f && f[g] || (p = h = 0) || d.pop())if ((a ? f.nodeName.toLowerCase() === y : 1 === f.nodeType) && ++p && (x && ((f[v] || (f[v] = {}))[e] = [w,
																																															   p]), f === t)) {
									break;
								}
							}
					...
					return r[v] ? r(t) : r.length > 1 ? (n = [e,
															  e,
															  "",
															  t], i.setFilters.hasOwnProperty(e.toLowerCase()) ? ut(function(e, n) {
		...
		function Nt(e, t) {
			var n = 0, o = t.length > 0, s = e.length > 0, a = function(a, l, c, p, h) {
				...
				if (v += x, o && x !== v) {
					...
					if (a) {
						if (v > 0)while (x--)b[x] || y[x] || (y[x] = H.call(p));
						y = Tt(y)
					}
		...
		jt.prototype = i.filters = i.pseudos, i.setFilters = new jt, n.sortStable = v.split("").sort(S).join("") === v, c(), [0,
																															  0].sort(S), n.detectDuplicates = E, x.find = ot, x.expr = ot.selectors, x.expr[":"] = x.expr.pseudos, x.unique = ot.uniqueSort, x.text = ot.getText, x.isXMLDoc = ot.isXML, x.contains = ot.contains
	}(e);
	var D = {};
	...
	x.Callbacks = function(e) {
		...
		var t, n, r, i, o, s, a = [], u = !e.once && [], l = function(f) {
			...
			add: function() {
				...
				return t = t || [], t = [e,
										 t.slice ? t.slice() : t], !a || n && !u || (r ? u.push(t) : l(t)), this
			}, fire: function() {
	...
	F.uid = 1, F.accepts = function(e) {
		...
		key: function(e) {
			...
			if (t === undefined) {
				...
				x.isArray(t) ? r = t.concat(t.map(x.camelCase)) : (i = x.camelCase(t), t in s ? r = [t,
																									 i] : (r = i, r = r in s ? [r] : r.match(w) || [])), n = r.length;
	...
	ct.optgroup = ct.option, ct.tbody = ct.tfoot = ct.colgroup = ct.caption = ct.thead, ct.th = ct.td, x.fn.extend({
		...
		x.fn[e] = function(e) {
			...
			for (; f > c; c++)if (i = e[c], i || 0 === i) {
				if ("object" === x.type(i)) {
					x.merge(h, i.nodeType ? [i] : i);
				} else if (rt.test(i)) {
					o = o || p.appendChild(t.createElement("div")), s = (nt.exec(i) || ["",
			...
			p.textContent = "", c = 0;
			while (i = h[c++])if ((!r || -1 === x.inArray(i, r)) && (u = x.contains(i.ownerDocument, i), o = mt(p.appendChild(i), "script"), u && dt(o), n)) {
				l = 0;
	...
	var vt, xt, bt = /^(none|table(?!-c[ea]).+)/, wt = /^margin/, Tt = RegExp("^(" + b + ")(.*)$", "i"), Ct = RegExp("^(" + b + ")(?!px)[a-z%]+$", "i"), kt = RegExp("^([+-])=(" + b + ")", "i"), Nt = {BODY: "block"}, Et = {
		...
		visibility: "hidden",
		display: "block"
	}, St = {letterSpacing: 0, fontWeight: 400}, jt = ["Top",
													   "Right",
													   "Bottom",
													   "Left"], Dt = ["Webkit",
																	  "O",
	...
	x.each(["height",
		...
		x.support.reliableMarginRight || (x.cssHooks.marginRight = {
			get: function(e, t) {
				return t ? x.swap(e, {display: "inline-block"}, vt, [e,
		...
		x.fn[t] = function(e) {
			return this.on(t, e)
					 ...
					 ajaxSettings: {
						 ...
						 accepts: {"*": sn, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"},
					 ...
					 ajax: function(e, t) {
						 ...
						 if (n = ln(on, c, t, T)) {
							 T.readyState = 1, u && p.trigger("ajaxSend", [T,
																		   c]), c.async && c.timeout > 0 && (s = setTimeout(function() {
								 T.abort("timeout")
							 }, c.timeout));
							 try {
								 v = 1, n.send(m, k)
	...
	function jn(e, t, n) {
		var r, i, o = 0, s = kn.length, a = x.Deferred().always(function() {
			...
			return a.notifyWith(e, [l,
									o,
									n]), 1 > o && u ? n : (a.resolveWith(e, [l]), !1)
		}, l = a.promise({
							 elem: e,
							 props: x.extend({}, t),
		...
		n.queue || (a = x._queueHooks(e, "fx"), null == a.unqueued && (a.unqueued = 0, u = a.empty.fire, a.empty.fire = function() {
			...
			l.always(function() {
				a.unqueued--, x.queue(e, "fx").length || a.empty.fire()
																				 ...
																				 f.overflowX,
																				 f.overflowY], "inline" === x.css(e, "display") && "none" === x.css(e, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", l.always(function() {
